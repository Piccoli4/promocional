        ...
        <View style={styles.container}>
            ...
            <View style={styles.sectionPlayoffs}>
                <View style={styles.playoffsIzquierda}>
                    ...
                    <Text style={styles.texto}>Ganador de 3ro vs 6to</Text>
                </View>
                <View>
                ...
                <View style={styles.playoffsDerecha}>
                    ...
                    <Text style={styles.vs}>vs</Text>
                    <Text style={styles.texto}>Ganador de 4to vs 5to</Text>
                </View>
            </View>
            ...
            <View style={styles.sectionPlayoffs}>
                <View style={styles.playoffsIzquierda}>
                    ...
                    <Text style={styles.vs}>vs</Text>
                    <Text style={styles.texto}>Perdedor de 3ro vs 6to</Text>
                </View>
                <View>
                    <Text style={styles.final}>FINAL</Text>
                </View>
                <View style={styles.playoffsDerecha}>
                    ...
                    <Text style={styles.vs}>vs</Text>
                    <Text style={styles.texto}>Perdedor de 4to vs 5to</Text>
                </View>
            </View>
        </View>
    );
